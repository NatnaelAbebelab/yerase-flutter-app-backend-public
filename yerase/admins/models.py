...
class Course(models.Model):
    ...
    description = models.CharField(max_length=255, blank=True)
    #objectives = ArrayField(models.CharField(max_length=100), blank=True, default=list)
    objectives = models.JSONField(default=list, blank=True)
    intro = models.CharField(blank=True, default='default-intro')
    lesson_count = models.CharField(max_length=255, default='0')
    total_duration = models.CharField(max_length=255, default='0')
    level = models.CharField(max_length=255, blank=True)
    is_certificated = models.CharField(default='no', blank=True)
...
class MealPlan(models.Model):
    ...
    recipe_count = models.CharField(max_length=255, blank=True, default='0')
    is_deleted = models.BooleanField(default=False)
    created_at = models.CharField(max_length=255, blank=True)
    updated_at = models.CharField(max_length=255, blank=True)
    record_time = models.DateTimeField(auto_now=True)
...
class AudiobookCategory(models.Model):
    ...
    color = models.CharField(max_length=255, blank=True)
    icon = models.CharField(max_length=255, blank=True)
    assigned_audio = models.CharField(max_length=255, default='0')
    is_deleted = models.BooleanField(default=False)
    created_at = models.CharField(max_length=255, blank=True)
    updated_at = models.CharField(max_length=255, blank=True)
    record_time = models.DateTimeField(auto_now=True)
...
class Item(models.Model):
    _id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(max_length=255, blank=True)
    category = models.CharField(max_length=255, blank=True, default='1')
...
class Cart(models.Model):
    _id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    owner = models.CharField(max_length=255, blank=True, default='owner')
...
class ItemReview(models.Model):
    _id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    active_user = models.CharField(max_length=255, blank=True)
    item = models.CharField(max_length=255, blank=True, default='1')
    rate = models.CharField(max_length=255, blank=True, default='5')
    review = models.CharField(max_length=255, blank=True, default='')
    status = models.CharField(max_length=255, blank=True, default='new')
    is_deleted = models.BooleanField(default=False)
...
class EcommercePC(models.Model):
    ...
    method_id = models.ForeignKey(PaymentMethod, on_delete=models.SET_DEFAULT, default=1)
    status = models.CharField(max_length=255, blank=True, default='new')
    is_deleted = models.BooleanField(default=False)
    created_at = models.CharField(max_length=255, blank=True)
    updated_at = models.CharField(max_length=255, blank=True)
